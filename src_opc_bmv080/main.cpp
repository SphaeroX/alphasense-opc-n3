...
void setup()
{
  ...
  {
    Serial.println("BMV080 not detected at I2C address 0x57. Freezing...");
    while (1)
      ;
  }
  bmv080.init();
...
void loop()
{
  ...
  if (opc.readData(sensorData))
  {
    ...
    else
    {
      ...
      float bmvPm1 = bmv080.PM1();
      float bmvPm25 = bmv080.PM25();
      float bmvPm10 = bmv080.PM10();
      bool bmvObs = bmv080.isObstructed();
      if (bmvOk)
      {
        Serial.printf("BMV080 PM1: %.2f ug/m3\n", bmvPm1);
        Serial.printf("BMV080 PM2.5: %.2f ug/m3\n", bmvPm25);
        Serial.printf("BMV080 PM10: %.2f ug/m3\n", bmvPm10);
      }
      else
      {
      ...
      sensorPoint.addField("bmv080_pm1", bmvPm1);
      sensorPoint.addField("bmv080_pm2_5", bmvPm25);
      sensorPoint.addField("bmv080_pm10", bmvPm10);
      sensorPoint.addField("bmv080_obstructed", bmvObs);
